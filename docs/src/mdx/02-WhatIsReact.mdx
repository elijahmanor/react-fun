...
Add your entry to [Facebook's Sites Using React Wiki](https://github.com/facebook/react/wiki/Sites-Using-React)

## Not a New Library

![](./images/days-since.png)

Unlike some libraries, React has been around for many years and despite its longevity, the API hasn't changed too much. When the API did change, the React team provided codemods to update existing code.
...
> ...you can set the directionality of it to be 2-Way Data Binding. That actually seems to be a good idea until you have a large-scale application and then it turns out you have no idea what's going on... and turns out to be an anti-pattern for large apps. --[Misko Hevery](https://www.youtube.com/watch?v=uD6Okha_Yj0#t=1785)
